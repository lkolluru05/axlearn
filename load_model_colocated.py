...
def _colocated_deserialize(
    ...
    #sys.stderr.write("_colocated_deserialize function")
    ...
    def run_deserializer():
        ...
        sys.stderr.write("run_serializer function")
        start_time = time.time()
        ...
        sys.stderr.write(f"deserialize took %.4f seconds.", time.time() - start_time)
        return result
